    ...
    <div class="container text-center">
        ...
        <div class="d-flex justify-content-center gap-3">
            ...
            @else
                ...
                <a href="{{ route('register.type') }}" class="btn btn-outline-wayna btn-lg">
...
<section class="py-5" style="background: linear-gradient(135deg, var(--wayna-black) 0%, #2a2a2a 100%);">
    <div class="container text-center">
        <h2 class="text-white">¿Quieres ser parte de Wayna?</h2>
        <p class="text-white-50 mb-4">Regístrate como cliente o emprendedor</p>
        <a href="{{ route('register.type') }}" class="btn btn-wayna btn-lg">
